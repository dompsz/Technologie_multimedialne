...
<head>
    ...
    <title>Lab 12a - Dashboard SCADA PRO</title>
            ...
            <div class="card">
                <form id="measure-form">
                    <div class="row g-1 mb-2 align-items-end">
                        <div class="col-2"><label class="form-label-sm">x1</label><input type="number" step="0.1" name="x1" class="form-control form-control-sm" required></div>
                        <div class="col-2"><label class="form-label-sm">x2</label><input type="number" step="0.1" name="x2" class="form-control form-control-sm" required></div>
                        <div class="col-2"><label class="form-label-sm">x3</label><input type="number" step="0.1" name="x3" class="form-control form-control-sm" required></div>
                        <div class="col-2"><label class="form-label-sm">x4</label><input type="number" step="0.1" name="x4" class="form-control form-control-sm" required></div>
                        <div class="col-2"><label class="form-label-sm">x5</label><input type="number" step="0.1" name="x5" class="form-control form-control-sm" required></div>
...
const liveChart = new Chart(document.getElementById('chart-live').getContext('2d'), {
    ...
    data: {
        labels: [],
        datasets: ['x1','x2','x3','x4','x5'].map((l, i) => ({
            label: l, data: [], borderColor: ['#ff6384','#36a2eb','#4bc0c2','#9966ff','#ff9f40'][i],
            tension: 0.2, radius: 4, pointStyle: 'rect', backgroundColor: ['#ff6384','#36a2eb','#4bc0c2','#9966ff','#ff9f40'][i], fill: false
        }))
    },
    options: {
