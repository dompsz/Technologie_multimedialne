...
<body>
    ...
    <div class="hero">
        <h1>Witaj w Laboratorium 2</h1>
        <p>Temat: Przetwarzanie obrazów i wideo w aplikacjach webowych.</p>
        <?php if(isset($_SESSION['lab2_user_id'])): ?>
            <p>Zalogowano jako: <strong><?php echo htmlspecialchars($_SESSION['lab2_username']); ?></strong></p>
            <div class="actions">
                <a href="dashboard.php" class="btn">Zadania Lab 2</a>
